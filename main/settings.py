...
from dotenv import load_dotenv # for loading project env vars
load_dotenv() # getting env vars
...
SECRET_KEY = 'django-insecure-hs-x68$j9vyv#6zsspv6)(5!8$84m7i1cv9u@ni4ekka=t29$a'
